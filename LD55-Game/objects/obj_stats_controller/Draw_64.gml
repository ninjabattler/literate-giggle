...
draw_healthbar(0, 1025, 427, 1080, (_player_health / _player_max_health) * 100, c_black, global.hp_color, global.hp_color, 0, true, false);
draw_sprite(spr_player_stats, 0, 0, 1080);

draw_set_halign(fa_center);
draw_set_valign(fa_middle);
draw_set_colour(c_black)
draw_text_transformed(641, 1006, _player_souls, 1, 1, 0);
