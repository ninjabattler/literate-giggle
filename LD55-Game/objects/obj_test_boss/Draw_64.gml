...
draw_healthbar(room_width - 610, 0, room_width, 45, (_hp / _max_hp) * 100, c_black, global.hp_color, global.hp_color, 1, true, true)
...
draw_sprite(spr_gui_boss_healthbar, 0, room_width, 0)

draw_set_color(global.text_color);
draw_set_font(fnt_boss_name)
draw_text_transformed(room_width - 8, 93, "Bound Minor Lich", 1, 1, 0);